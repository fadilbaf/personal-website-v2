      ...
      <CardHeader className="pb-3 border-b border-neutral-100 dark:border-white/5">
        <div className="flex items-center justify-between gap-3 relative z-30">
          ...
          <div className="relative z-30" ref={dropdownRef}>
            ...
            {/* Dropdown panel */}
            {isFilterOpen && (
              <div className="absolute right-0 top-full mt-2 z-50 w-72 sm:w-80 rounded-xl border border-neutral-200 bg-white p-4 shadow-xl dark:border-neutral-800 dark:bg-neutral-900 transition-all duration-200">
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              isSelected
                                ...
                                : "bg-neutral-100/80 hover:bg-neutral-200/80 active:bg-neutral-200 text-neutral-600 border-neutral-200/80 dark:bg-neutral-800/80 dark:hover:bg-neutral-700/80 dark:active:bg-neutral-700 dark:text-neutral-300 dark:border-neutral-700/50"
                            )}
                          >
                            {opt.label}
                          </button>
